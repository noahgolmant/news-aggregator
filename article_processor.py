...
def generate_doc_matrix():
    ...
    idf_process = Process(target=process_idfs, args=(articles,))
    tf_process  = Process(target=process_tfs, args=(articles,))
